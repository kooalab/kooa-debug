...
function t() {
  return t = Object.assign ? Object.assign.bind() : function(e2) {
    for (var t2 = 1; t2 < arguments.length; t2++) {
      var s2 = arguments[t2];
      for (var n2 in s2)
        Object.prototype.hasOwnProperty.call(s2, n2) && (e2[n2] = s2[n2]);
    }
    return e2;
...
var i = class extends e {
  constructor(e2 = {}) {
    ...
    super(), i2 = this, this.name = "SwupHeadPlugin", this.requires = { swup: ">=4" }, this.defaults = { persistTags: false, persistAssets: false, awaitAssets: false, timeout: 3e3 }, this.options = void 0, this.updateHead = async function(e3, { page: { html: t2 } }) {
      const o = new DOMParser().parseFromString(t2, "text/html"), { removed: a, added: l } = function(e4, t3, { shouldPersist: r2 = () => false } = {}) {
        const i3 = Array.from(e4.children), o2 = Array.from(t3.children), a2 = (l2 = i3, o2.reduce((e5, t4, s2) => (l2.some((e6) => n(t4, e6)) || e5.push({ el: t4, index: s2 }), e5), []));
        var l2;
